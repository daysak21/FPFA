        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($current_page == 'contactus.php') ? 'active' : ''; ?>" href="contactus.php">Contact</a>
                    </li>
                    <?php
                        if(isset($_SESSION['username'])){                            
                            echo "<li class='nav-item'>
                            <a class='nav-link " . ($current_page == 'profile.php' ? 'active' : '') . "' href='profile.php'>My Account</a>
                        </li>";
                        }
                        else{
                            echo "<li class='nav-item'>
                            <a class='nav-link " . ($current_page == 'user_registration.php' ? 'active' : '') . "' href='user_registration.php'>Register</a>
                        </li>";
                        }
                    ?>
                </ul>
