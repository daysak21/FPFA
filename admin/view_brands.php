...
<head>
    ...
    <title>Brand Management Panel</title>
            ...
            <div class="panel-content">
                <table class="user-table">
                    ...
                    <tbody>
                        ...
                        $row_count = mysqli_num_rows($get_brands_result);

                        if ($row_count == 0) {
                            echo '<tr><td colspan="3" style="text-align: center; padding: 20px;">No brands found</td></tr>';
                        } else {
                            while ($row_fetch_brands = mysqli_fetch_array($get_brands_result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style='display: flex; gap: 8px;'>
                                            <button class='action-btn btn-edit' onclick=\"editBrand('{$brand_id}')\">
                                            ...
                                            <button class='action-btn btn-delete' onclick=\"confirmDelete('delete_brand.php?delete_brand={$brand_id}', '{$brand_title}')\">
                                                <svg width='14' height='14' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
