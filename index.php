    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://cdn.mos.cms.futurecdn.net/w9wUBMaoTm42V6grtNepUe-1200-80.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption">
                      Thinkpads
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="https://gmedia.playstation.com/is/image/SIEPDC/playstation-ecosystem-ps4-to-ps5-keyart-01-en-09aug21?$facebook$" class="d-block w-100" alt="...">
                    <div class="carousel-caption">
                      PS4
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="https://mediaserver.goepson.com/ImConvServlet/imconv/ef36f7eee3b2e10d708c2b1da43a7fc8dff56bef/1200Wx1200H?use=banner&hybrisId=B2C&assetDescr=STD_front_02_02p" class="d-block w-100" alt="...">
                    <div class="carousel-caption">
                    </div>
                </div>
            </div>
